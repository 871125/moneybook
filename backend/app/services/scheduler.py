...
def _build_transaction_syncers(settings) -> list:
    ...
    return [
        WooriBankTransactionSyncer(u1, settings.user1_woori_bank_api),
        KakaoBankTransactionSyncer(u1, settings.user1_kakao_bank_api),
        HanaBankTransactionSyncer(u1, settings.user1_hana_bank_api),
        SaemaeulTransactionSyncer(u1, settings.user1_saemaeul_api),
        WooriCardSyncer(u1, settings.user1_woori_card_api),
        HanaCardSyncer(u1, settings.user1_hana_card_api),
        ShinhanCardSyncer(u1, settings.user1_shinhan_card_api),
        WooriBankTransactionSyncer(u2, settings.user2_woori_bank_api),
        KakaoBankTransactionSyncer(u2, settings.user2_kakao_bank_api),
        HanaBankTransactionSyncer(u2, settings.user2_hana_bank_api),
        SaemaeulTransactionSyncer(u2, settings.user2_saemaeul_api),
        WooriCardSyncer(u2, settings.user2_woori_card_api),
        HanaCardSyncer(u2, settings.user2_hana_card_api),
        ShinhanCardSyncer(u2, settings.user2_shinhan_card_api),
    ]
...
def _build_asset_syncers(settings) -> list:
    u1, u2 = settings.user1_name, settings.user2_name
    return [
        WooriBankAssetSyncer(u1, settings.user1_woori_bank_api),
        KakaoBankAssetSyncer(u1, settings.user1_kakao_bank_api),
        HanaBankAssetSyncer(u1, settings.user1_hana_bank_api),
        SaemaeulAssetSyncer(u1, settings.user1_saemaeul_api),
        SamsungSecAssetSyncer(u1, settings.user1_samsung_sec_api),
        MiraeSecAssetSyncer(u1, settings.user1_mirae_sec_api),
        MeritzSecAssetSyncer(u1, settings.user1_meritz_sec_api),
        NHSecAssetSyncer(u1, settings.user1_nh_sec_api),
        ...
        WooriBankAssetSyncer(u2, settings.user2_woori_bank_api),
        KakaoBankAssetSyncer(u2, settings.user2_kakao_bank_api),
        HanaBankAssetSyncer(u2, settings.user2_hana_bank_api),
        SaemaeulAssetSyncer(u2, settings.user2_saemaeul_api),
        SamsungSecAssetSyncer(u2, settings.user2_samsung_sec_api),
        MiraeSecAssetSyncer(u2, settings.user2_mirae_sec_api),
        MeritzSecAssetSyncer(u2, settings.user2_meritz_sec_api),
        NHSecAssetSyncer(u2, settings.user2_nh_sec_api),
